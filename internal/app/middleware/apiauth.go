...
func ApiAuthMiddleware(apiKeys []string, header string, allowUri []string) gin.HandlerFunc {
    patterns := util.Map(allowUri, func(s string) *regexp.Regexp { return regexp.MustCompile(s) })
